...
public class Korean1_Activity extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tts = new TextToSpeech(cThis, (status -> {
            ...
            sttBtn = (Button) findViewById(R.id.button);
            ...
            sttBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    FuncVoiceOut("주문하실 메뉴를 말씀해 주세요.");
                    if (ContextCompat.checkSelfPermission(cThis, Manifest.permission.RECORD_AUDIO) != PackageManager.PERMISSION_GRANTED) {
                        ActivityCompat.requestPermissions(Korean1_Activity.this, new String[]{Manifest.permission.RECORD_AUDIO}, 1);
